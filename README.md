...
- 英語がうまく喋れない
- 日常会話さえできればいいと思っている
- 実際に、英語の勉強のためにフィリピンにも行ったが、日本語で伝えたいことの20%くらいしか話せず、英語文章がすぐててこないことがある
- 英会話例文集などを持って行って、見ていっても、この結果だった

#### 原因

- 英会話例文集とか見ても、自分が一生使わなさそうなものが多すぎる
  - 覚えるコストが高いわりに、報酬が見合っていない
  - もっと他に覚えるべき文章があるはず

### 製品説明（具体的な製品の説明）

ユーザーの **音を全て録音、言語化し** データを貯め続け、 **自分がよく使っている文章順で** その文と英訳を表示するアプリ
